...
//		int[] score = new int[5];
//		String num[];
//		int b = 0, e = 0; 																			// 문자열 인덱스 시작값 = b(begin), 끝 값 = e(end)
//		int j = 0; 																					// 배열 카운트 값
//		double total = 0; 																			// 평균 값
//		
//
...
//			return;
//		
//		if(s.length()>20)																			//숫자를 너무 많이 써도 걸림.
//			return;
//
//		for (int i = 0; i < s.length(); i++) {
//			if (s.charAt(i) == ' ') { 																// 띄어쓰기 검사
...
//					if (s.charAt(b) == '1' && s.charAt(b + 1) == '0' && s.charAt(e) == '0') { 		//100만 올 수 있으므로 100이 맞는지 확인
//						score[j] = 100;																//바로 100 넣어 주면 됨.
//						j++;																		
//					} else
//						System.out.println("점수를 잘못 입력합");
//				} else
//					System.out.println("점수를 잘못 입력합");
//				b = i + 1; 																			//띄어쓰기 다음 인덱스 자리 값을 시작값에 입력
//			}
//		}
//		
//		for (int i = 0; i < score.length; i++)
